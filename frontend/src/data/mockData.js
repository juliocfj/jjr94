...
export const portfolioData = {
  ...
  en: {
    ...
    contact: {
      ...
      credlyLabel: "Credly Certifications",
      overviewTitle: "Quick Overview",
      collaborationTitle: "Let's Work Together",
      collaborationText: "Whether you need infrastructure automation, cloud migration, security implementation, or technical leadership, I'm here to help transform your IT operations.",
      sendEmail: "Send Email",
      connectLinkedIn: "Connect on LinkedIn",
      footer: "© 2025 Julio Cesar de Faria Junior. Built with modern web technologies",
      labels: {
        email: "Email",
        location: "Location",
