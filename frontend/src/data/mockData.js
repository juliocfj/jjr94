...
export const portfolioData = {
  pt: {
    ...
    skills: {
      description: "Expertise técnica em plataformas cloud, ferramentas de automação e gerenciamento moderno de infraestrutura.",
      categories: {
        "Cloud & Infraestrutura": ["Azure", "GCP", "AWS", "UniFi"],
      "Automação & DevOps": ["Terraform", "Ansible", "Jenkins", "Docker"],
      "Segurança": ["Fortinet", "Sophos", "VPN", "IAM", "LGPD/GDPR"],
  ...
  it: {
    ...
    projects: {
      description: "Progetti reali che dimostrano competenza tecnica, risultati misurabili e soluzioni innovative nei domini di infrastruttura cloud, automazione e sicurezza.",
      list: [
      {
        id: 1,
        title: "SharePoint Marco Zero",
    ...
    skills: {
      description: "Competenza tecnica in piattaforme cloud, strumenti di automazione e gestione moderna dell'infrastruttura.",
      categories: {
        "Cloud & Infrastruttura": ["Azure", "GCP", "AWS", "UniFi"],
      "Automazione & DevOps": ["Terraform", "Ansible", "Jenkins", "Docker"],
      "Sicurezza": ["Fortinet", "Sophos", "VPN", "IAM", "GDPR/LGPD"],
